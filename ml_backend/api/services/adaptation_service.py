...
def extract_keywords(text: str, extract_skills: bool = True, top_n: int = 100, max_tokens: int = 510,
...
def get_keywords_score(resume: Resume, vacancy_text: str, clean: bool) -> AdaptationResponse:
    ...
    resume_keywords = extract_keywords(resume.CleanedText, extract_skills=False)
    vacancy_keywords, vacancy_skills = extract_keywords(vacancy_text)
